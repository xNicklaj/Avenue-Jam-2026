...
namespace Sisus.Init
{
	...
	/// </summary>
	[RequireImplementors]
	public interface ILateUpdate : IEnableable
	{
		/// <summary>
		...
		/// For example a follow camera should always be implemented in <see cref="LateUpdate"/> because it tracks objects that might have moved inside <see cref="IUpdate.Update">Update</see>.
		/// </para>
		/// </summary>
