...
namespace Sisus.Init.EditorOnly.Internal
{
	...
	internal static class EditorDecoratorInjector
	{
		...
		private static void ProcessInspectorElement(Editor rootEditor, InspectorType inspectorType, InspectorElement inspectorElement)
		{
			...
			var isDebugMode = inspectorType is InspectorType.InspectorWindowDebugMode;
			...
			if(!InitializerEditorUtility.TryGetEditorDecoratorType(targetType, out var editorDecoratorType))
			{
				return;
			}
