namespace Sisus.Init
{
	...
	{
		/// <summary>
		/// Default execution order for the <see cref="Init.IdTag"/> component.
		/// </summary>
		public const int IdTag = -32000;

		/// <summary>
		/// Default execution order for the <see cref="Internal.ServiceTag"/> and <see cref="Internal.Services"/> components.
		/// </summary>
