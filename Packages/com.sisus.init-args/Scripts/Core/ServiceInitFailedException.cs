...
namespace Sisus.Init
{
	...
	public class ServiceInitFailedException : InitArgsException
	{
		...
		/// <summary>
		/// Type of the object that is the service or will provide the service.
		/// </summary>
		/// <remarks>
		/// For services registered using the <see cref="ServiceAttribute"/>, this is the class which has the attribute.
		/// </remarks>
		...
		internal static InitArgsException Create([DisallowNull] ServiceInfo serviceInfo, ServiceInitFailReason reason, Object asset = null, Object sceneObject = null, object initializerOrWrapper = null, Exception exception = null, Type concreteType = null, Type missingDependencyType = null, LocalServices localServices = null)
		{
		...
		private static string GenerateMessage([DisallowNull] ServiceInfo serviceInfo, ServiceInitFailReason reason, [AllowNull] Object asset, [AllowNull] Object sceneObject, object initializerOrWrapper, [AllowNull] Type concreteType, Exception exception)
		{
			...
			sb.Append(reason switch
			{
				...
				ServiceInitFailReason.CreatingServiceProviderFailed => $"An exception occurred while trying to create service initializer {TypeUtility.ToString(serviceInfo.classWithAttribute)}:\n{exception}",
				...
				ServiceInitFailReason.ServiceProviderResultNotConvertible => $"{TypeUtility.ToString(initializerOrWrapper?.GetType())} result of type {TypeUtility.ToString(concreteType)} was not convertible to all the defining types specified for the service.",
		...
		internal static void AppendServiceInfo([DisallowNull] StringBuilder sb, [DisallowNull] ServiceInfo serviceInfo, [AllowNull] Object asset = null, [AllowNull] Object sceneObject = null)
		{
			...
			if(serviceInfo.classWithAttribute != null && serviceInfo.concreteType != serviceInfo.classWithAttribute)
			{
				...
				sb.Append(TypeUtility.ToString(serviceInfo.classWithAttribute));
				sb.Append(".");
			}
