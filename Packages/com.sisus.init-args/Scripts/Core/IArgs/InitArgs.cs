...
namespace Sisus.Init
{
	...
	public static class InitArgs
	{
		...
		/// <see cref="TryGet{TClient, TArgument}"/>; otherwise, <see langword="false"/>.
		/// </returns>
		public static bool Received<TClient, TArgument>()
			where TClient : IArgs<TArgument>
		{
			return Arg<TArgument>.arg.TryGetValue(typeof(TClient), out var dependency) && dependency.received;
		}
		...
		/// <see cref="TryGet{TClient, TFirstArgument, TSecondArgument}"/>; otherwise, <see langword="false"/>.
		/// </returns>
		public static bool Received<TClient, TFirstArgument, TSecondArgument>()
			where TClient : IArgs<TFirstArgument, TSecondArgument>
		{
			return Args<TFirstArgument, TSecondArgument>.args.TryGetValue(typeof(TClient), out var dependency) && dependency.received;
		}
		...
		/// <see cref="TryGet{TClient, TFirstArgument, TSecondArgument, TThirdArgument}"/>; otherwise, <see langword="false"/>.
		/// </returns>
		public static bool Received<TClient, TFirstArgument, TSecondArgument, TThirdArgument>()
			where TClient : IArgs<TFirstArgument, TSecondArgument, TThirdArgument>
		{
			return Args<TFirstArgument, TSecondArgument, TThirdArgument>.args.TryGetValue(typeof(TClient), out var dependency) && dependency.received;
		}
		...
		/// <see cref="TryGet{TClient, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument}"/>; otherwise, <see langword="false"/>.
		/// </returns>
		public static bool Received<TClient, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>()
			where TClient : IArgs<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>
		{
			return Args<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>.args.TryGetValue(typeof(TClient), out var dependency) && dependency.received;
		}
		...
		/// <see cref="TryGet{TClient, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument}"/>; otherwise, <see langword="false"/>.
		/// </returns>
		public static bool Received<TClient, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>()
			where TClient : IArgs<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>
		{
			return Args<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>.args.TryGetValue(typeof(TClient), out var dependency) && dependency.received;
		}
		...
		/// <see cref="TryGet{TClient, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument}"/>; otherwise, <see langword="false"/>.
		/// </returns>
		public static bool Received<TClient, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>()
			where TClient : IArgs<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>
		{
			return Args<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>.args.TryGetValue(typeof(TClient), out var dependency) && dependency.received;
		}
