...
{
	internal sealed class LocalServiceGetter
	{
		...
		static LocalServiceGetter()
		{
			...
			if(methodDefinition is null)
			{
				...
				methodDefinition = typeof(LocalServiceGetter).GetMethod(nameof(AlwaysFalse), BindingFlags.NonPublic | BindingFlags.Static);
			}
		}

		public LocalServiceGetter([DisallowNull] Type definingType)
		{
