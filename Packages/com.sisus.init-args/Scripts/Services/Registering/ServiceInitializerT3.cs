...
namespace Sisus.Init
{
	...
	public abstract class ServiceInitializer<TService, TFirstArgument, TSecondArgument, TThirdArgument> : IServiceInitializer<TService, TFirstArgument, TSecondArgument, TThirdArgument>
	{
		/// <inheritdoc/>
