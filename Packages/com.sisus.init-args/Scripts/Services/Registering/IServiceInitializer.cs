	...
	public interface IServiceInitializer
	{
		...
		object InitTarget(params object[] arguments)
		{
			foreach(var interfaceType in GetType().GetInterfaces())
			{
				...
				&& interfaceType.GetMethod(nameof(InitTarget)) is { } initTargetMethod
				&& initTargetMethod.GetParameters().Length == arguments.Length)
				{
					return initTargetMethod.Invoke(this, arguments);
				}
			}
