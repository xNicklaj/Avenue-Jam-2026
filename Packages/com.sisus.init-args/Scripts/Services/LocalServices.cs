...
namespace Sisus.Init.Internal
{
	...
	internal sealed class LocalServices
	{
		...
		public IEnumerable<Object> All()
		{
			...
			return servicesComponents.SelectMany(c => c.providesServices.Select(s => s.service)).Concat(serviceTags.Select(t => t.Service)).Distinct();
		}
		...
		void Init()
		{
			...
			infosByDefiningTypes = new((servicesComponents.Length + serviceTags.Length + initializers.Length) * 2);
