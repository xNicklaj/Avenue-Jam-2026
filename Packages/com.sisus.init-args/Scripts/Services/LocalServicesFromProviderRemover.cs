...
{
	internal sealed class LocalServicesFromProviderRemover
	{
		...
		static LocalServicesFromProviderRemover()
		{
			...
			if(methodDefinition is null)
			{
				...
				methodDefinition = typeof(LocalServicesFromProviderRemover).GetMethod(nameof(DoNothing), BindingFlags.NonPublic | BindingFlags.Instance);
			}
		}

		public LocalServicesFromProviderRemover([DisallowNull] Type definingType)
		{
