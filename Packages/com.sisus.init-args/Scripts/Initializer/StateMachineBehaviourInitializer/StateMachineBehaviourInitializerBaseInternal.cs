...
namespace Sisus.Init.Internal
{
		...
		where TStateMachineBehaviour : StateMachineBehaviour
	{
		...
		bool IValueByTypeProvider.IsValueTypeSupported(Type valueType) => valueType.IsAssignableFrom(typeof(TStateMachineBehaviour));
		...
		protected void ThrowMissingInitArgumentsException<TArgument>() => throw InitializerUtility.GetMissingInitArgumentsException(GetType(), typeof(TStateMachineBehaviour), typeof(TArgument));
		...
		private protected void ThrowIfMissing<TArgument>(TArgument argument)
		{
			if(argument == Null)
			{
				throw InitializerUtility.GetMissingInitArgumentsException(GetType(), typeof(TStateMachineBehaviour), typeof(TArgument));
			}
		}
		#endif
