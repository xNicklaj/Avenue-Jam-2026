...
namespace Sisus.Init
{
		...
		where TClient : MonoBehaviour, IInitializable<TFirstArgument, TSecondArgument>
	{
		...
		private protected override void Reset() => Reset<InitializerBase<TClient, TFirstArgument, TSecondArgument>, TClient, TFirstArgument, TSecondArgument>(this, gameObject);
