...
namespace Sisus.Init
{
			...
			where TClient : ScriptableObject, IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>
	{
		...
		InitTargetAsync(TClient target)
		{
			...
			var fifthAwaitable = this.fifthArgument.GetValueAsync(cancellationToken: cancellationToken);
			var sixthAwaitable = this.sixthArgument.GetValueAsync(cancellationToken: cancellationToken);
