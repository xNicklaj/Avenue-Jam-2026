...
namespace Sisus.Init
{
	...
	public enum NullArgumentGuard
	{
		...
		/// <summary>
		/// Warn about <see langword="null"/> arguments in Edit Mode and throw an exception if <see langword="null"/> arguments are detected at runtime.
		/// </summary>
		All = EditModeWarning | RuntimeException
	}
