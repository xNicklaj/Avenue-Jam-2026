...
{
	/// <summary>
	/// A base class for a component that can specify the eleven arguments used to initialize a component that implements
	...
	public abstract class Initializer<TClient, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument, TSeventhArgument, TEighthArgument, TNinthArgument, TTenthArgument, TEleventhArgument>
		: InitializerBase<TClient, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument, TSeventhArgument, TEighthArgument, TNinthArgument, TTenthArgument, TEleventhArgument>
			where TClient : MonoBehaviour, IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument, TSeventhArgument, TEighthArgument, TNinthArgument, TTenthArgument, TEleventhArgument>
	{
		...
		InitTargetAsync(TClient target)
		{
			...
			var tenthAwaitable = this.tenthArgument.GetValueAsync(this, cancellationToken: cancellationToken);
			var eleventhAwaitable = this.eleventhArgument.GetValueAsync(this, cancellationToken: cancellationToken);
			...
			var tenthArgument = await tenthAwaitable;
			var eleventhArgument = await eleventhAwaitable;
		...
		private protected sealed override void Reset()
		{
				...
				&& sharedInstance is WaitForService waitForService)
			{
				...
				HandleMakeWaitForService(this, ref tenthArgument, waitForService);
				HandleMakeWaitForService(this, ref eleventhArgument, waitForService);
			}
		}
		#endif
	}
