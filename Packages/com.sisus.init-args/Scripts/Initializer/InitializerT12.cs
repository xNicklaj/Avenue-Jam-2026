...
namespace Sisus.Init
{
			...
			where TClient : MonoBehaviour, IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument, TSeventhArgument, TEighthArgument, TNinthArgument, TTenthArgument, TEleventhArgument, TTwelfthArgument>
	{
		...
		InitTargetAsync(TClient target)
		{
			...
			var twelfthAwaitable = this.twelfthArgument.GetValueAsync(this, cancellationToken: cancellationToken);
			...
			var twelfthArgument = await twelfthAwaitable;
		...
		private protected sealed override void Reset()
		{
				...
				&& sharedInstance is WaitForService waitForService)
			{
				...
				HandleMakeWaitForService(this, ref twelfthArgument, waitForService);
			}
		}
		#endif
	}
