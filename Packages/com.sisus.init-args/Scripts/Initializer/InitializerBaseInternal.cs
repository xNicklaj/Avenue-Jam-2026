...
namespace Sisus.Init.Internal
{
	...
	where TClient : Object
	{
		...
		{
			if(initState is InitState.Failed) failures.Add(NullGuardResult.ErrorBox(((IInitializerEditorOnly)this).NullGuardFailedMessage ?? $"{GetType().Name} failed to initialize client of type {TypeUtility.ToString(typeof(TClient))}."));
		}
		#endif
	}
}