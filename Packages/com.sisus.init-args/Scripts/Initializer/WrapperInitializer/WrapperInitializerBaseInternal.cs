...
namespace Sisus.Init.Internal
{
		...
		where TWrapper : Wrapper<TWrapped>
	{
		...
		{
			if(initState is InitState.Failed) failures.Add(NullGuardResult.ErrorBox(((IInitializerEditorOnly)this).NullGuardFailedMessage ?? $"Failed to initialize wrapped object of type {TypeUtility.ToString(typeof(TWrapped))}."));
		}
		#endif
	}
}