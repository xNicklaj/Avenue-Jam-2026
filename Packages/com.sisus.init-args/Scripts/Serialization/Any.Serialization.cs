...
namespace Sisus.Init.Serialization
{
	...
	internal sealed class _Integer : Serializable<int>, IValueProvider<int> { }
	...
	/// </summary>
	[Serializable, EditorBrowsable(EditorBrowsableState.Never)]
	internal sealed class _String : Serializable<string>, IValueProvider<string> { }
	...
	/// </summary>
	[Serializable, EditorBrowsable(EditorBrowsableState.Never)]
	internal sealed class _Float : Serializable<float>, IValueProvider<float> { }
	...
	/// </summary>
	[Serializable, EditorBrowsable(EditorBrowsableState.Never)]
	internal sealed class _Boolean : Serializable<bool>, IValueProvider<bool> { }
	...
	/// </summary>
	[Serializable, EditorBrowsable(EditorBrowsableState.Never)]
	internal sealed class _Double : Serializable<double>, IValueProvider<double> { }
	...
	/// </summary>
	[Serializable, EditorBrowsable(EditorBrowsableState.Never)]
	internal sealed class _Char : Serializable<char>, IValueProvider<char> { }

	[Serializable, EditorBrowsable(EditorBrowsableState.Never)]
	internal abstract class Serializable<T> : IValueProvider<object>, IComparable, IComparable<T>, IConvertible, IEquatable<T>, INullGuard where T : IComparable, IComparable<T>, IConvertible, IEquatable<T>
	{
		public T value;
		...
		bool IValueProvider<object>.HasValueFor(Component client) => value is not null;
		NullGuardResult INullGuard.EvaluateNullGuard(Component client) => value is null ? NullGuardResult.ValueMissing : NullGuardResult.Passed;
