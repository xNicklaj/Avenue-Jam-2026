...
InternalsVisibleTo(InitArgs.Services),
InternalsVisibleTo(InitArgs.UserExtensions),
...
namespace Sisus.Init
{
	internal static class AssemblyNames
	{
		public static class InitArgs
		{
			...
			public const string Services = "InitArgs.Services";
			public const string UserExtensions = "InitArgs.UserExtensions";
