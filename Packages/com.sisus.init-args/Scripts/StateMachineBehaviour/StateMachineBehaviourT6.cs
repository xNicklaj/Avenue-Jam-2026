...
namespace Sisus.Init
{
		...
		IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>
	{
		...
		/// <summary>
		/// Provides the state machine behaviour with the object that it depends on.
		/// <para>
		/// You can think of the <see cref="Init"/> method as a parameterized constructor alternative for the state machine behaviour.
		/// </para>
		/// <para>
		...
		/// </para>
		/// </summary>
		/// <param name="firstArgument"> The first object that this state machine behaviour depends on. </param>
		/// <param name="secondArgument"> The second object that this state machine behaviour depends on. </param>
		/// <param name="thirdArgument"> The third object that this state machine behaviour depends on. </param>
		/// <param name="fourthArgument"> The fourth object that this state machine behaviour depends on. </param>
		/// <param name="fifthArgument"> The fifth object that this state machine behaviour depends on. </param>
		/// <param name="sixthArgument"> The sixth object that this state machine behaviour depends on. </param>
		...
		/// <see langword="null"/> or an <see cref="UnityEngine.Object"/> which has been <see cref="UnityEngine.Object.Destroy(UnityEngine.Object)">destroyed</see>.
		/// <example>
		/// <code>
