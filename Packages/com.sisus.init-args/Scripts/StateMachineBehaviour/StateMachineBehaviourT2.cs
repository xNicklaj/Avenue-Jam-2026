...
namespace Sisus.Init
{
		...
		IInitializable<TFirstArgument, TSecondArgument>
	{
		...
		/// </para>
		/// </summary>
		/// <param name="firstArgument"> First object that this <see cref="StateMachineBehaviour"/> depends on. </param>
		/// <param name="secondArgument"> Second object that this <see cref="StateMachineBehaviour"/> depends on. </param>
		...
		/// A script's lifetime lasts until it is manually destroyed using <see cref="Object.Destroy(Object)"/>.
		/// </para>
		/// <para>
		...
		/// </para>
		/// <para>
		/// You can use the <see cref="AssertNotNull{T}"/> method to log an assertion to the Console
		/// if the argument is <see cref="Null">null</see>.
		/// <example>
		/// <code>
		/// protected override void ValidateArguments(IInputManager inputManager, Camera camera)
