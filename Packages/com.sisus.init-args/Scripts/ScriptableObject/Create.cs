...
namespace Sisus.Init
{
	...
	public static class Create
	{
		...
		/// <typeparam name="TArgument"> Type of the argument passed to the ScriptableObject's <see cref="IArgs{TArgument}">Init</see> function. </typeparam>
		...
		/// </summary>
		/// <typeparam name="TScriptableObject"> Type of the <see cref="ScriptableObject"/> to create. </typeparam>
		/// <typeparam name="TFirstArgument"> Type of the first argument passed to the ScriptableObject's <see cref="IArgs{TArgument}">Init</see> function. </typeparam>
		/// <typeparam name="TSecondArgument"> Type of the second argument passed to the ScriptableObject's <see cref="IArgs{TArgument}">Init</see> function. </typeparam>
		...
		/// <typeparam name="TFirstArgument"> Type of the first argument passed to the ScriptableObject's <see cref="IArgs{TArgument}">Init</see> function. </typeparam>
		/// <typeparam name="TSecondArgument"> Type of the second argument passed to the ScriptableObject's <see cref="IArgs{TArgument}">Init</see> function. </typeparam> 
		/// <typeparam name="TThirdArgument"> Type of the third argument passed to the ScriptableObject's <see cref="IArgs{TArgument}">Init</see> function. </typeparam> 
		/// <param name="firstArgument"> The first object that the created <see cref="ScriptableObject"/> depends on. </param>
		/// <param name="secondArgument"> The second object that the created <see cref="ScriptableObject"/> depends on. </param>
		...
		/// <typeparam name="TSecondArgument"> Type of the second argument passed to the ScriptableObject's <see cref="IArgs{TArgument}">Init</see> function. </typeparam> 
		/// <typeparam name="TThirdArgument"> Type of the third argument passed to the ScriptableObject's <see cref="IArgs{TArgument}">Init</see> function. </typeparam>
		/// <typeparam name="TFourthArgument"> Type of the fourth argument passed to the ScriptableObject's <see cref="IArgs{TArgument}">Init</see> function. </typeparam>
		/// <param name="firstArgument"> The first object that the created <see cref="ScriptableObject"/> depends on. </param>
		/// <param name="secondArgument"> The second object that the created <see cref="ScriptableObject"/> depends on. </param>
		/// <param name="thirdArgument"> The third object that the created <see cref="ScriptableObject"/> depends on. </param>
		...
		/// <typeparam name="TThirdArgument"> Type of the third argument passed to the ScriptableObject's <see cref="IArgs{TArgument}">Init</see> function. </typeparam>
		/// <typeparam name="TFourthArgument"> Type of the fourth argument passed to the ScriptableObject's <see cref="IArgs{TArgument}">Init</see> function. </typeparam> 
		/// <typeparam name="TFifthArgument"> Type of the fifth argument passed to the ScriptableObject's <see cref="IArgs{TArgument}">Init</see> function. </typeparam> 
		/// <param name="firstArgument"> The first object that the created <see cref="ScriptableObject"/> depends on. </param>
		/// <param name="secondArgument"> The second object that the created <see cref="ScriptableObject"/> depends on. </param>
		/// <param name="thirdArgument"> The third object that the created <see cref="ScriptableObject"/> depends on. </param>
		/// <param name="fourthArgument"> The fourth object that the created <see cref="ScriptableObject"/> depends on. </param>
		...
		/// <typeparam name="TFourthArgument"> Type of the fourth argument passed to the ScriptableObject's <see cref="IArgs{TArgument}">Init</see> function. </typeparam> 
		/// <typeparam name="TFifthArgument"> Type of the fifth argument passed to the ScriptableObject's <see cref="IArgs{TArgument}">Init</see> function. </typeparam>
		/// <typeparam name="TSixthArgument"> Type of the sixth argument passed to the ScriptableObject's <see cref="IArgs{TArgument}">Init</see> function. </typeparam>
		/// <param name="firstArgument"> The first object that the created <see cref="ScriptableObject"/> depends on. </param>
		/// <param name="secondArgument"> The second object that the created <see cref="ScriptableObject"/> depends on. </param>
		/// <param name="thirdArgument"> The third object that the created <see cref="ScriptableObject"/> depends on. </param>
		/// <param name="fourthArgument"> The fourth object that the created <see cref="ScriptableObject"/> depends on. </param>
