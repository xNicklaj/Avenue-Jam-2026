...
{
	/// <summary>
	/// <see cref="Initializer{,}"/> for the <see cref="Chase"/> component.
	/// </summary>
	[AddComponentMenu("Initialization/Demo/Initializers/Chase Initializer")]
	public sealed class ChaseInitializer : Initializer<Chase, ITrackable, Movable>
	{
		#if UNITY_EDITOR
