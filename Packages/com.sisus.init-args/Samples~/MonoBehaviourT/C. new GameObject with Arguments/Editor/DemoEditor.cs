...
namespace Sisus.Init.Demos.GameObjectT
{
	...
	{
		const string helpText = "Showcases how components that derive from MonoBehaviour<T...> can be initialized with all the objects that they depend on using new GameObject<TComponent...>.\n\n" +
