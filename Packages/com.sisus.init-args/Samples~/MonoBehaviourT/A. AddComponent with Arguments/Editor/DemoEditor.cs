...
namespace Sisus.Init.Demos.AddComponent
{
	...
	{
		const string helpText = "Showcases how components that derive from MonoBehaviour<T...> can be initialized with all the objects that they depend on using the AddComponent extension methods.\n\n" +
