...
namespace FIMSpace.FEditor
{
    ...
    {
        public static readonly int MAX_TEX_SIZE = 16384;
        ...
        public static TextureInfo StartEditingTextureAsset( TextureImporter sourceTex, Texture2D source, TextureInfo src, bool saveAndReimport = true )
        {
            try
            {
                ...
                sourceTex.maxTextureSize = MAX_TEX_SIZE;
                ...
                sourceSets.maxTextureSize = MAX_TEX_SIZE;
        ...
        public struct TextureInfo
        {
            ...
            public TextureInfo( TextureImporter sourceTex, Texture2D source )
            {
                ...
                maxTextureSize = sourceTex.maxTextureSize;
            ...
            public void RestoreOn( TextureImporter sourceTex, Texture2D source, bool apply = true )
            {
                ...
                sourceTex.maxTextureSize = maxTextureSize;
        ...
        public static Texture2D DuplicateAsPNG( Texture2D source, string postFix = "-ToPNG", bool saveAndReimport = true, bool addNewAlphaChannelIfNeeded = false )
        {
            ...
            Texture2D newPng = source;

            try
            {
                FTextureEditorToolsMethods.StartEditingTextureAsset(srcImporter, source, srcInfo, true);

                Color32[] pix = source.GetPixels32();
                newPng = new Texture2D(source.width, source.height, TextureFormat.RGBA32, source.mipmapCount > 1);
                newPng.SetPixels32(pix);

                FTextureEditorToolsMethods.EndEditingTextureAsset(source, srcInfo, true);
                string directory = System.IO.Path.GetDirectoryName(AssetDatabase.GetAssetPath(source));
                ...
                if (pimp != null)
                {
                    srcInfo.RestoreOn(pimp, newPng, false);
        ...
        public static void ScaleTextureFile( Texture2D source, Texture2D output, Vector2 dimensions, int quality = 4, bool transparentIcon = false )
        {
            ...
            if( sourceTex != null && outTex != null )
            {
                ...
                int sMaxTexSize = outTex.maxTextureSize;
                ...
                try
                {
                    ...
                    sourceTex.maxTextureSize = sMaxTexSize;
